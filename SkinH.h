...
// Maybe should be ignored libriarys
/*******************************************************
Single-Thread(libc.lib):
libcmt.lib msvcrt.lib libcd.lib libcmtd.lib msvcrtd.lib
Multiple-Thread(libcmt.lib):
libc.lib msvcrt.lib libcd.lib libcmtd.lib msvcrtd.lib
Multiple-Thread DLL(msvcrt.lib):
libc.lib libcmt.lib libcd.lib libcmtd.lib msvcrtd.lib
Single-Thread Debug(libcd.lib):
libc.lib libcmt.lib msvcrt.lib libcmtd.lib msvcrtd.lib
Multiple-Thread Debug(libcmtd.lib):
libc.lib libcmt.lib msvcrt.lib libcd.lib msvcrtd.lib
Multiple-Thread Debug DLL(msvcrtd.lib):
...
extern "C"
{
	...
	int __stdcall SkinH_AttachEx(
		LPCSTR strSkinFile,		//皮肤文件路径
		LPCSTR strPassword		//皮肤密钥
		);
